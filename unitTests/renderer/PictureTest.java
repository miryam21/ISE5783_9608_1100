...
//    }
    ...
    public class PictureTest {
        ...
        Material poolM = new Material().setKD(0.7).setKS(0.8).setNShininess(150);
        Material blueM = new Material().setKD(0.7).setKS(0.8).setNShininess(150).setKR(0.5);
        Material railM = new Material().setKD(0.7).setKS(0.8).setNShininess(50).setKT(0.75);

        Scene scene = new Scene("pool");
        Camera camera = new Camera(new Point(0, -200, 50), new Vector(0, 5, -1), new Vector(0, 1, 5)) //
        ...
        scene.geometries.add(new Cuboid(
                new Point(-60, -20,4 ),    // Position the cuboid at the center of the scene or adjust as needed
                30,                   // Set the width of the cuboid to a suitable value
                40,                   // Set the height of the cuboid to a suitable value
                400,                   // Set the depth of the cuboid to a suitable value
                new Color(PINK),       // Set the color of the cuboid to a desired value
                1.0                    // Set the opacity of the cuboid to fully opaque (1.0)
        ));
...
//        scene.geometries.add(new BallsGrid(new Point(26, -36, 10), new Vector(-1, 0, 0), new Vector(0, 1, 0), 4, 2, 4, poolM));
//        scene.geometries.add(new Sphere(4,new Point(-38, -28, 16)).setEmission(new Color(pink)).setMaterial(poolM));
//        scene.geometries.add(new Sphere(4,new Point(-22, -4, 16)).setEmission(new Color(pink)).setMaterial(poolM));
//        scene.geometries.add(new Sphere(4,new Point(30, 12, 16)).setEmission(new Color(pink)).setMaterial(poolM));
//
//        scene.geometries.add(new Sphere(4,new Point(60, -40, 4)).setEmission(new Color(pink)).setMaterial(poolM));
//        scene.geometries.add(new Sphere(4,new Point(70, -50, 4)).setEmission(new Color(pink)).setMaterial(poolM));
//        scene.geometries.add(new Sphere(4,new Point(65, -30, 4)).setEmission(new Color(pink)).setMaterial(poolM));
...
//        scene.geometries.add(new Sphere(4,lightPlace).setEmission(yellow).setMaterial(new Material().setKD(0.5).setKS(0.5).setNShininess(50).setKT(0.85)));
//        scene.geometries.add(new Sphere(10,lightPlace.subtract(new Vector(0, 0, 4))).
//                setEmission(new Color(50, 50, 35)).setMaterial(new Material().setKD(0.5).setKS(0.5).setNShininess(50).setKT(0.9)));
